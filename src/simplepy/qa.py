...
def build_index(doc_path: str):
    ...
    if not llm_api_key:
        raise RuntimeError("Please set OPENAI_API_KEY in your environment to use OpenAI LLM.")
...
def main(argv: Optional[list[str]] = None) -> None:
    ...
    parser = argparse.ArgumentParser(description="Ask questions about a local document using LlamaIndex")
