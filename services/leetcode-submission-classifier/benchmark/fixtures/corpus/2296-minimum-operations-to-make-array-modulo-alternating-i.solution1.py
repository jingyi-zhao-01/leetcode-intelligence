...
# problem_id: minimum-operations-to-make-array-modulo-alternating-i
# source_path: LeetCode-Solutions-master/Python/minimum-operations-to-make-array-modulo-alternating-i.py
